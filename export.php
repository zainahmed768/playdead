        ...
        <section class="mycharacter-sec bounty-sec">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="export-heading-wrapper">
                            <h4>CRS EXPORT PAGE</h4>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="notes-wrapper">
                            <div class="notes-heading-wrapper">
                                <h5>Misc Stats Note</h5>
                            </div>
