                        ...
                        <ul class="nav nav-tabs justify-content-center" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                    aria-controls="profile" aria-selected="false">Guild Treasure</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab"
                                    aria-controls="contact" aria-selected="false">Guild Treasure</a>
                            </li>
                        </ul>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4 my-auto">
                                                                    <div class="guild-img-wrapper">
                                                                        <figure>
                                                                            <img src="img/gult1.png"
                                                                                class="guild-img img-fluid" alt="">
                                                                        </figure>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    <div class="guild-content-wrapper">
                                                                        ...
                                                                        <div class="marcus-and-member">
                                                                            <h5><img src="img/macrus.png" class="mr-3"
                                                                                    alt=""> Marcus Fenix</h5>
                                                                            <h5><img src="img/member.png" class="mr-3"
                                                                                    alt="">Members <span
                                                                                    class="total-member">: 24</span>
                                                                            </h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
