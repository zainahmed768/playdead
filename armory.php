    ...
    <div class="frame-wrapper">
        ...
        <section class="armory_sec">
            <div class="container">
                ...
                <div class="all-armory">
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="armory-box">
                                <div class="img-box">
                                    <figure><img src="img/armory1.png" alt="" class="img-fluid"></figure>
                                    <div class="shade">
                                        <img src="img/armory-shade.png" alt="" class="img-fluid">
                                    </div>
                                </div>
                                <div class="txt">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="armory-box">
                                <div class="img-box">
                                    <figure><img src="img/armory2.png" alt="" class="img-fluid"></figure>
                                    <div class="shade">
                                        <img src="img/armory-shade.png" alt="" class="img-fluid">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="armory-box">
                                <div class="img-box">
                                    <figure><img src="img/armory3.png" alt="" class="img-fluid"></figure>
                                    <div class="shade">
                                        <img src="img/armory-shade.png" alt="" class="img-fluid">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="armory-box">
                                <div class="img-box">
                                    <figure><img src="img/armory4.png" alt="" class="img-fluid"></figure>
                                    <div class="shade">
                                        <img src="img/armory-shade.png" alt="" class="img-fluid">
                                    </div>
                                </div>
