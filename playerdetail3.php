...
<!-- css start here -->
<link rel="stylesheet" href="css/playerdetail3.css">
<!-- css start here -->
...
<div class="frame-wrapper">
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-7">
                    <!-- Inner Row Start Here -->
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="DetailBox BoxOne">
                                <div class="level">
                                    <div class="form-group">
                                        <label for="forlevel">level</label>
                                        <input type="text" value="02" id="forlevel" readonly>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="characterDetail">
                                <div class="button-group text-center">
                                    <button class="btn">pvp</button>
                                    <button class="btn">pve</button>
                                </div>
                                <div class="characterImg text-center">
                                    <figure><img src="img/playerthree.png" alt=""></figure>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="DetailBox BoxTwo">
                                <div class="level for-hidden">
                                    <div class="form-group">
                                        <label for="forlevel">level</label>
                                        <input type="text" value="02" id="forlevel" readonly>
                                    </div>
                                ...
                                <div class="Detail-inner">
                                    ...
                                    <div class="itemsBox text-white">
                                        <div class="clothings">
                                            <div class="imgbox">
                                                <figure><img src="img/item8.png" alt=""></figure>
                                            </div>
                                            <div class="contentDv">
                                        ...
                                        <div class="clothings">
                                            <div class="imgbox">
                                                <figure><img src="img/item9.png" alt=""></figure>
                                            </div>
                                            <div class="contentDv">
                                        ...
                                        <div class="clothings">
                                            <div class="imgbox">
                                                <figure><img src="img/item10.png" alt=""></figure>
                                            </div>
                                            <div class="contentDv">
                                        ...
                                        <div class="clothings">
                                            <div class="imgbox">
                                                <figure><img src="img/item11.png" alt=""></figure>
                                            </div>
                                            <div class="contentDv">
                                        ...
                                        <div class="clothings">
                                            <div class="imgbox">
                                                <figure><img src="img/item12.png" alt=""></figure>
                                            </div>
                                            <div class="contentDv">
                                        ...
                                        <div class="clothings">
                                            <div class="imgbox">
                                                <figure><img src="img/item13.png" alt=""></figure>
                                            </div>
                                            <div class="contentDv">
                    ...
                    <!-- Weapons Html Start -->
                    <div class="weaponsDv-withBorder">
                        <div class="forTop-border">
                            <figure><img src="img/weaponstop.png" alt=""></figure>
                        </div>
                        <div class="weaponsDv">
                            <div class="title">
                                <h4>weapons</h4>
                            </div>
                            <div class="weapons-Slider text-white">
                                <div class="weapons-items">
                                    <div class="imgbox">
                                        <figure><img src="img/weapon1.png" alt=""></figure>
                                    </div>
                                    <div class="contentDv">
                                        <ul class="lists">
                                            <li>H : 621</li>
                                ...
                                <div class="weapons-items">
                                    <div class="imgbox">
                                        <figure><img src="img/weapon2.png" alt=""></figure>
                                    </div>
                                    <div class="contentDv">
                                        <ul class="lists">
                                            <li>H : 621</li>
                                ...
                                <div class="weapons-items">
                                    <div class="imgbox">
                                        <figure><img src="img/weapon3.png" alt=""></figure>
                                    </div>
                                    <div class="contentDv">
                                        <ul class="lists">
                                            <li>H : 621</li>
                                ...
                                <div class="weapons-items">
                                    <div class="imgbox">
                                        <figure><img src="img/weapon4.png" alt=""></figure>
                                    </div>
                                    <div class="contentDv">
                                        <ul class="lists">
                                            <li>H : 621</li>
                        ...
                        <div class="forBottom-border">
                            <figure><img src="img/weaponsbottom.png" alt=""></figure>
                        </div>
                    </div>
                    <!-- Weapons Html End -->
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="all-about-players text-white">
                                ...
                                <div class="armored-stats">
                                    <div class="title">
                                        <h4>total armored stats</h4>
                                    </div>
                                    <div class="armoured-info info">
                                        <div class="property">
                                            <h4>Health</h4>
                                        </div>
                                        <div class="value">
                                ...
                                <div class="actionsBtn">
                                    <div class="button-group">
                                        <button class="btn">Mics Stats note</button>
                                        <button onclick="location.href='characterstats.php'" class="btn">Stats</button>
                                    </div>
                                    <div class="exportBtn">
                            ...
                            <!-- Legend Dv Start Here -->
                            <div class="legendDv-withBorder">
                                <div class="forTop-border">
                                    <figure><img src="img/legendtop.png" alt=""></figure>
                                </div>
                                <div class="LegendDv">
                                    <div class="title">
                                        <h4>legends & cosmics</h4>
                                    </div>
                                    <div class="Legend-Slider text-white">
                                ...
                                <div class="forBottom-border">
                                    <figure><img src="img/legendbottom.png" alt=""></figure>
                                </div>
                            </div>
                            <!-- Legend Dv End Here -->
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="inventroy-Box">
                                <div class="beforeImg">
                                    <figure><img src="img/beforeimg.png" alt=""></figure>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                            ...
                            <div class="Misc-withBorder">
                                ...
                                <div class="MiscDv">
                                    ...
                                    <div class="Misc-Slider text-white">
