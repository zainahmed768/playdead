    ...
    <div class="frame-wrapper">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="character-list animate__animated animate__fadeInLeft animate__delay-1s">
                    ...
                    <div class="col-lg-6 text-center">
                        <div class="main-charater-img">
                            <figure>
                                <img src="img/character1.png" class="animate__animated animate__fadeInDown animate__delay-1s img-fluid" alt="">
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="character-specification animate__animated animate__fadeInRight animate__delay-1s">
                            <figure>
                                <img src="img/sniper.png" class="char-name img-fluid" alt="">
                            </figure>
                            <p class="golden-color">Skilled marksmen that use focus to decimate their prey. Snipers have high burst damage and a knack for survival. Snipers prefer ranged weapons and have a special affinity for pets.</p>
